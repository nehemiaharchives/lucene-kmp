...
class DocumentsWriter @OptIn(ExperimentalAtomicApi::class) constructor(
   ...
   */
    ...
    suspend fun flushAllThreads(): Long {
        ...
        logger.debug {
            "DW.flushAllThreads() enter fullFlush=${flushControl.isFullFlush} queued=${flushControl.numQueuedFlushes()} blocked=${flushControl.numBlockedFlushes()} flushing=${flushControl.numFlushingDWPT()}"
        }
