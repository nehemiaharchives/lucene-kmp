 ...
 * [DateFormatProvider][java.text.spi.DateFormatProvider] class should
 ...
 * Otherwise, they call the [isSupportedLocale][.isSupportedLocale]
 * methods of installed providers for the appropriate interface to find one that
 * supports the requested locale. If such a provider is found, its other
 * methods are called to obtain the requested object or name.  When checking
 * whether a locale is supported, the [ locale&#39;s extensions][Locale] are ignored by default. (If locale's extensions should
 ...
 * [getCandidateLocales][java.util.ResourceBundle.Control.getCandidateLocales]
 ...
 * [System.setProperty] is discouraged and it may not affect
 * the order.
 ...
 * Refer to [CLDR Releases](https://cldr.unicode.org/index/downloads)
 ...
 * @since        1.6
 */
@Ported(from = "java.util.spi.LocaleServiceProvider")
abstract class LocaleServiceProvider(/*ignore: Void*/) {
    /**
     * Initializes a new locale service provider.
     *
     * @throws  SecurityException
     * If a security manager has been installed and it denies
     * [RuntimePermission(&quot;localeServiceProvider&quot;)][RuntimePermission]
     */
    //protected constructor() : this(checkPermission())
     ...
     *
     * @param locale a `Locale` to be tested
     * @return `true` if the given `locale` is supported by this
    ...
    open fun isSupportedLocale(locale: Locale): Boolean {
        for (available in getAvailableLocales()) {
            if (locale == available) {
                return true
            }
        }
    ...
    /*companion object {
        private fun checkPermission(): Void {
            val sm: java.lang.SecurityManager = System.getSecurityManager()
            if (sm != null) {
                sm.checkPermission(java.lang.RuntimePermission("localeServiceProvider"))
            }
            return null
        }
    }*/
