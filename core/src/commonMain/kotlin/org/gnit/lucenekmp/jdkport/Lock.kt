 ...
 * the lock that can timeout ([.tryLock]).
 *
 *
 ...
 * @author Doug Lea
 */
@Ported(from = "java.util.concurrent.locks.Lock")
interface Lock {
    /**
     * Acquires the lock.
     *
     ...
     *  * is [interrupted][Thread.interrupt] while acquiring the
     ...
     * current thread has not been [interrupted][Thread.interrupt].
     *
     *
     ...
     *
     *  * has its interrupted status set on entry to this method; or
     *  * is [interrupted][Thread.interrupt] while acquiring
