...
/**
 * port of CharacterData03
 *
 * The CharacterData class encapsulates the large tables found in
 * Java.lang.Character.  */
@Ported(from = "java.lang.CharacterData03")
internal class CharacterData03 private constructor() // The X table has 2048 entries for a total of 4096 bytes.
    : CharacterData() {
    ...
    override fun getNumericValue(ch: Int): Int {
        ...
        val retval: Int = when (`val` and 0xC00) {
            (0x00000000) -> -1
    ...
    override fun isWhitespace(ch: Int): Boolean {
        return (getProperties(ch) and 0x00007000) == 0x00004000
    }
    ...
    override fun isMirrored(ch: Int): Boolean {
        return (getProperties(ch) and -0x80000000) != 0
    }

    companion object {
        val instance: CharacterData = CharacterData03()
        val X: CharArray =
            ("\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000" +
                    "\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000" +
                    "\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000" +
        ...
        val A: IntArray = IntArray(6)
        const val A_DATA: String = "\u0000\u7005\u0000\u7005\u0000\u7005\u7800\u0000\u7800\u0000\u7800\u0000"

        // The B table has 6 entries for a total of 12 bytes.
        val B: CharArray = ("\u0038\u0038\u0038\u0000\u0000\u0000").toCharArray()
