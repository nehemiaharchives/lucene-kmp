 ...
 */
class SortedSetDocValuesField private constructor(
    name: String,
    bytes: BytesRef,
    fieldType: FieldType
    ...
    companion object {
        ...
        /**
         * Creates a new [SortedSetDocValuesField] with the specified 64-bit long value that also
        ...
        fun indexedField(
            ...
            return SortedSetDocValuesField(name, bytes, INDEXED_TYPE)
        }
         ...
         *
         *
         * This query also works with fields that have indexed [SortedDocValuesField]s.
         *
         *
