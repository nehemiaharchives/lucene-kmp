...
fun interface AttributeReflector {
     ...
     * invocation of [ ][org.gnit.lucenekmp.analysis.tokenattributes.CharTermAttributeImpl.reflectWith] would call this
     * method once using `org.gnit.lucenekmp.analysis.tokenattributes.CharTermAttribute.class` as
