...
class Constants {
    ...
    companion object {
        ...
        val IS_HOTSPOT_VM: Boolean = /*HotspotVMOptions.IS_HOTSPOT_VM*/ false // TODO: impossible to implement in Kotlin common. JVM specific.
        ...
        private val MAX_VECTOR_SIZE: Int = /*HotspotVMOptions.get("MaxVectorSize").map(java.lang.Integer::valueOf).orElse(0)*/ 0

        /** true for an AMD cpu with SSE4a instructions.  */
        private val HAS_SSE4A: Boolean = /*HotspotVMOptions.get("UseXmmI2F").map(java.lang.Boolean::valueOf).orElse(false)*/ false
        ...
        /*private fun logSecurityWarning(property: String) {
            val log: java.util.logging.Logger =
                java.util.logging.Logger.getLogger(org.apache.lucene.util.Constants::class.java.getName())
