 ...
 */
@Ported(from = "com.carrotsearch.randomizedtesting.generators.RealisticUnicodeGenerator")
class RealisticUnicodeGenerator : StringGenerator() {
    override fun ofCodeUnitsLength(r: Random, minCodeUnits: Int, maxCodeUnits: Int): String {
        ...
        val block = r.nextInt(blockStarts.size)

        val sb = StringBuilder()
        while (length > 0) {
            val cp = RandomNumbers.randomIntBetween(r, blockStarts[block], blockEnds[block])
    ...
    companion object {
        ...
        private val blockStarts = intArrayOf(
        ...
        private val blockEnds = intArrayOf(
