...
class FastDecompressionCompressingCodec : CompressingCodec {
    ...
    constructor(
        ...
        if (withSegmentSuffix) "FastDecompressionCompressingStoredFields" else "",
    ...
    /** Default constructor. */
    constructor() : this(1 shl 14, 256, false, 10)
}
