...
class DeflateWithPresetCompressingCodec : CompressingCodec {
    ...
    constructor(
        ...
        if (withSegmentSuffix) "DeflateWithPresetCompressingStoredFields" else "",
    ...
    /** No-arg constructor. */
    constructor() : this(1 shl 18, 512, false, 10)
}
