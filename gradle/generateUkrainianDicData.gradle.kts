...
abstract class GenerateUkrainianDictionaryKotlinTask : DefaultTask() {
    ...
    fun generateKotlin() {
        ...
        fun writePartsStreaming(baseName: String, file: File, maxFileSize: Int = 1_000_000): List<String> {
            ...
            BufferedInputStream(file.inputStream()).use { input ->
                ...
                fun openPart() {
                    ...
                    writer.write("// Auto-generated by generateUkrainianDictionaryKotlin. Do not edit.\n")
        ...
        run {
            val helperFile = outputRoot.resolve("UkrainianDictionaryData_Base64.kt")
            BufferedWriter(OutputStreamWriter(helperFile.outputStream(), Charsets.UTF_8)).use { w ->
                w.write("// Auto-generated by generateUkrainianDictionaryKotlin. Do not edit.\n")
                w.write("package ")
                w.write(packageName)
                w.write("\n\n")
        ...
        val dictParts = writePartsStreaming("ukrainianDictData", dict)
        val infoParts = writePartsStreaming("ukrainianInfoData", info)
