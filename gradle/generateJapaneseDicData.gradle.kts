...
abstract class GenerateJapaneseDictionaryKotlinTask : DefaultTask() {
    @get:InputFile
    ...
    fun generateKotlin() {
        ...
        for ((name, file) in files) {
            if (!file.isFile) {
                throw GradleException("Japanese dictionary data not found for $name at ${file.absolutePath}")
            }
        }

        val packageName = "org.gnit.lucenekmp.analysis.ja.dict"
        ...
        fun writePartsStreaming(baseName: String, file: File, maxFileSize: Int = 1_000_000): List<String> {
            ...
            BufferedInputStream(file.inputStream()).use { input ->
                ...
                fun openPart() {
                    ...
                    val partFile = outputRoot.resolve("JapaneseDictionaryData_${baseName}_${partIndex}.kt")
                    val writer = CountingWriter(BufferedWriter(OutputStreamWriter(partFile.outputStream(), Charsets.UTF_8)))
                    writer.write("// Auto-generated by generateJapaneseDictionaryKotlin. Do not edit.\n")
        ...
        run {
            val helperFile = outputRoot.resolve("JapaneseDictionaryData_Base64.kt")
            BufferedWriter(OutputStreamWriter(helperFile.outputStream(), Charsets.UTF_8)).use { w ->
                w.write("// Auto-generated by generateJapaneseDictionaryKotlin. Do not edit.\n")
                w.write("package ")
                w.write(packageName)
                w.write("\n\n")
        ...
        val main = buildString {
            append("// Auto-generated by generateJapaneseDictionaryKotlin. Do not edit.\n")
            append("package ").append(packageName).append("\n\n")
            append("internal object JapaneseDictionaryData {\n")
        ...
        outputRoot.resolve("JapaneseDictionaryData.kt").writeText(main)
    }
}

val generateJapaneseDictionaryData = tasks.register("generateJapaneseDictionaryData", GenerateJapaneseDictionaryKotlinTask::class.java) {
    val baseDir = rootProject.file("gradle/kuromoji")
    ...
    outputDir.set(layout.buildDirectory.dir("generated/ja/kuromoji/kotlin"))
}

tasks.matching {
    it.name.startsWith("compile") && it.name.contains("Kotlin")
}.configureEach {
    dependsOn(generateJapaneseDictionaryData)
}
