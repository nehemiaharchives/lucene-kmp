...
/** Test [MarathiNormalizer]. */
class TestMarathiNormalizer : BaseTokenStreamTestCase() {
    ...
    private fun check(input: String, output: String) {
        ...
        val tf: TokenFilter = MarathiNormalizationFilter(tokenizer)
    ...
    fun testEmptyTerm() {
        val a = object : Analyzer() {
            override fun createComponents(fieldName: String): TokenStreamComponents {
                ...
                return TokenStreamComponents(tokenizer, MarathiNormalizationFilter(tokenizer))
            }
        }
        checkOneTerm(a, "", "")
        a.close()
