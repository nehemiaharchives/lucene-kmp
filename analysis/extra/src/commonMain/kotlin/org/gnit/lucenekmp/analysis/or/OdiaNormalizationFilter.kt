...
/**
 * A [TokenFilter] that applies [OdiaNormalizer] to normalize the orthography.
 *
 ...
 */
class OdiaNormalizationFilter(input: TokenStream) : TokenFilter(input) {
    private val normalizer = OdiaNormalizer()
