...
/**
 * A [TokenFilter] that applies [PunjabiNormalizer] to normalize the orthography.
 *
 ...
 */
class PunjabiNormalizationFilter(input: TokenStream) : TokenFilter(input) {
    private val normalizer = PunjabiNormalizer()
