...
/**
 * A [TokenFilter] that applies [SwahiliNormalizer] to normalize the orthography.
 *
 ...
 */
class SwahiliNormalizationFilter(input: TokenStream) : TokenFilter(input) {
    private val normalizer = SwahiliNormalizer()
