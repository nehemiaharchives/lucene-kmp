...
/**
 * A [TokenFilter] that applies [IgboNormalizer] to normalize the orthography.
 *
 ...
 */
class IgboNormalizationFilter(input: TokenStream) : TokenFilter(input) {
    private val normalizer = IgboNormalizer()
