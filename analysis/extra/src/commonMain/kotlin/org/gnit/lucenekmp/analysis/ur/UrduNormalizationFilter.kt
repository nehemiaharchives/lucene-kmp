...
/**
 * A [TokenFilter] that applies [UrduNormalizer] to normalize the orthography.
 *
 ...
 */
class UrduNormalizationFilter(input: TokenStream) : TokenFilter(input) {
    private val normalizer = UrduNormalizer()
