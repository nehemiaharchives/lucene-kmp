...
/** Analyzer for Swahili. */
class SwahiliAnalyzer : StopwordAnalyzerBase {
    ...
    override fun createComponents(fieldName: String): TokenStreamComponents {
        ...
        result = SwahiliNormalizationFilter(result)
        result = StopFilter(result, stopwords)
        result = SwahiliStemFilter(result)
    ...
    companion object {
        /** File containing default Swahili stopwords. */
...
# Source: stopwords-iso (sw) local clone: ../stopwords-sw/stopwords-sw.txt
akasema
alikuwa
alisema
baada
