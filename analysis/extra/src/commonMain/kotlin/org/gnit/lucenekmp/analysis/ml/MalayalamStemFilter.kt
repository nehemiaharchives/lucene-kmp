...
/** A [TokenFilter] that applies [MalayalamStemmer] to stem Malayalam words. */
class MalayalamStemFilter(input: TokenStream) : TokenFilter(input) {
    private val termAtt: CharTermAttribute = addAttribute(CharTermAttribute::class)
    private val keywordAtt: KeywordAttribute = addAttribute(KeywordAttribute::class)
    private val stemmer = MalayalamStemmer()
