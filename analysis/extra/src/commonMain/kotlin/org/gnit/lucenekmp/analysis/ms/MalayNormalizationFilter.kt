...
/**
 * A [TokenFilter] that applies [MalayNormalizer] to normalize the orthography.
 *
 ...
 */
class MalayNormalizationFilter(input: TokenStream) : TokenFilter(input) {
    private val normalizer = MalayNormalizer()
