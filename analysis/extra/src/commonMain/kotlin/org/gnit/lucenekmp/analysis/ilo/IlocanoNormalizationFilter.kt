...
/**
 * A [TokenFilter] that applies [IlocanoNormalizer] to normalize the orthography.
 *
 ...
 */
class IlocanoNormalizationFilter(input: TokenStream) : TokenFilter(input) {
    private val normalizer = IlocanoNormalizer()
