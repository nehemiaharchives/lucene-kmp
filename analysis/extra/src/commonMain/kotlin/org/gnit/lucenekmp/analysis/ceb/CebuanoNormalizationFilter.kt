...
/**
 * A [TokenFilter] that applies [CebuanoNormalizer] to normalize Latin-script variants.
 *
 ...
 */
class CebuanoNormalizationFilter(input: TokenStream) : TokenFilter(input) {
    private val normalizer = CebuanoNormalizer()
