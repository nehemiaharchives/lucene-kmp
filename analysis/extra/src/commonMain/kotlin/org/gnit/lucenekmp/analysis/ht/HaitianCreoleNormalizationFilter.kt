...
/**
 * A [TokenFilter] that applies [HaitianCreoleNormalizer] to normalize the orthography.
 *
 ...
 */
class HaitianCreoleNormalizationFilter(input: TokenStream) : TokenFilter(input) {
    private val normalizer = HaitianCreoleNormalizer()
