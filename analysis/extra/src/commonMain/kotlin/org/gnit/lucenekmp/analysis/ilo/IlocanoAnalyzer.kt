...
/** Analyzer for Ilocano. */
class IlocanoAnalyzer : StopwordAnalyzerBase {
    ...
    override fun createComponents(fieldName: String): TokenStreamComponents {
        ...
        result = IlocanoNormalizationFilter(result)
        result = StopFilter(result, stopwords)
        result = IlocanoStemFilter(result)
    ...
    companion object {
        /** File containing default Ilocano stopwords. */
...
# Sources: Ilocano grammar references for determiners, linkers, pronouns, negatives and particles.
a
adda
ak
ako
