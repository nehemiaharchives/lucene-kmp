...
/**
 * A [TokenFilter] that applies [JavaneseNormalizer] to normalize the orthography.
 *
 ...
 */
class JavaneseNormalizationFilter(input: TokenStream) : TokenFilter(input) {
    private val normalizer = JavaneseNormalizer()
