...
/** Analyzer for Yoruba. */
class YorubaAnalyzer : StopwordAnalyzerBase {
    ...
    override fun createComponents(fieldName: String): TokenStreamComponents {
        ...
        result = YorubaNormalizationFilter(result)
        result = StopFilter(result, stopwords)
        result = YorubaStemFilter(result)
    ...
    companion object {
        /** File containing default Yoruba stopwords. */
...
# Source: local stopwords-iso Yoruba list plus normalized forms.
a
an
ati
awon
