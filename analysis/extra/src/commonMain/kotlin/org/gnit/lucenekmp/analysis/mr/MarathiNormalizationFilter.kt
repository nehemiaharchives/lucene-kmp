...
/**
 * A [TokenFilter] that applies [MarathiNormalizer] to normalize the orthography.
 *
 ...
 */
class MarathiNormalizationFilter(input: TokenStream) : TokenFilter(input) {
    private val normalizer = MarathiNormalizer()
