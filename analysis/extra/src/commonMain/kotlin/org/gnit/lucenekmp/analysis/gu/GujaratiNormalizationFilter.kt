...
/**
 * A [TokenFilter] that applies [GujaratiNormalizer] to normalize the orthography.
 *
 ...
 */
class GujaratiNormalizationFilter(input: TokenStream) : TokenFilter(input) {
    private val normalizer = GujaratiNormalizer()
