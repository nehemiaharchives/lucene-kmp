...
/**
 * A [TokenFilter] that applies [HausaNormalizer] to normalize the orthography.
 *
 ...
 */
class HausaNormalizationFilter(input: TokenStream) : TokenFilter(input) {
    private val normalizer = HausaNormalizer()
