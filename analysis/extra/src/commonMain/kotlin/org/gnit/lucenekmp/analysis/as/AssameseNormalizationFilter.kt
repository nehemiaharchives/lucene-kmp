...
/**
 * A [TokenFilter] that applies [AssameseNormalizer] to normalize Assamese orthography.
 *
 ...
 */
class AssameseNormalizationFilter(input: TokenStream) : TokenFilter(input) {
    private val normalizer = AssameseNormalizer()
