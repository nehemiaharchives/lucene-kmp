...
/** Analyzer for Urdu. */
class UrduAnalyzer : StopwordAnalyzerBase {
    ...
    override fun createComponents(fieldName: String): TokenStreamComponents {
        ...
        result = UrduNormalizationFilter(result)
        result = StopFilter(result, stopwords)
        result = UrduStemFilter(result)
    ...
    companion object {
        /** File containing default Urdu stopwords. */
...
# Source: stopwords-iso (ur) local clone: stopwords-iso/stopwords-iso.json
آئی
آئے
آج
آخر
