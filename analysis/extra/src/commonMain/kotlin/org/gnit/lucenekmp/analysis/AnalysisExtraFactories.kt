...
import org.gnit.lucenekmp.analysis.`as`.AssameseNormalizationFilterFactory
import org.gnit.lucenekmp.analysis.`as`.AssameseStemFilterFactory
...
import org.gnit.lucenekmp.analysis.kn.KannadaNormalizationFilterFactory
import org.gnit.lucenekmp.analysis.kn.KannadaStemFilterFactory
...
import org.gnit.lucenekmp.analysis.my.BurmeseNormalizationFilterFactory
import org.gnit.lucenekmp.analysis.my.BurmeseStemFilterFactory
...
import org.gnit.lucenekmp.analysis.si.SinhalaNormalizationFilterFactory
import org.gnit.lucenekmp.analysis.si.SinhalaStemFilterFactory
...
import org.gnit.lucenekmp.analysis.uz.UzbekNormalizationFilterFactory
import org.gnit.lucenekmp.analysis.uz.UzbekStemFilterFactory
...
object AnalysisExtraFactories {
    ...
    fun ensureInitialized() {
        ...
        AnalysisSPIRegistry.register(
            TokenFilterFactory::class,
            AssameseNormalizationFilterFactory.NAME,
            AssameseNormalizationFilterFactory::class
        ) { args -> AssameseNormalizationFilterFactory(args) }
        AnalysisSPIRegistry.register(
            TokenFilterFactory::class,
            AssameseStemFilterFactory.NAME,
            AssameseStemFilterFactory::class
        ) { args -> AssameseStemFilterFactory(args) }
        AnalysisSPIRegistry.register(
            TokenFilterFactory::class,
        ...
        AnalysisSPIRegistry.register(
            TokenFilterFactory::class,
            KannadaNormalizationFilterFactory.NAME,
            KannadaNormalizationFilterFactory::class
        ) { args -> KannadaNormalizationFilterFactory(args) }
        AnalysisSPIRegistry.register(
            TokenFilterFactory::class,
            KannadaStemFilterFactory.NAME,
            KannadaStemFilterFactory::class
        ) { args -> KannadaStemFilterFactory(args) }
        AnalysisSPIRegistry.register(
            TokenFilterFactory::class,
        ...
        AnalysisSPIRegistry.register(
            TokenFilterFactory::class,
            BurmeseNormalizationFilterFactory.NAME,
            BurmeseNormalizationFilterFactory::class
        ) { args -> BurmeseNormalizationFilterFactory(args) }
        AnalysisSPIRegistry.register(
            TokenFilterFactory::class,
            BurmeseStemFilterFactory.NAME,
            BurmeseStemFilterFactory::class
        ) { args -> BurmeseStemFilterFactory(args) }
        AnalysisSPIRegistry.register(
            TokenFilterFactory::class,
        ...
        AnalysisSPIRegistry.register(
            TokenFilterFactory::class,
            SinhalaNormalizationFilterFactory.NAME,
            SinhalaNormalizationFilterFactory::class
        ) { args -> SinhalaNormalizationFilterFactory(args) }
        AnalysisSPIRegistry.register(
            TokenFilterFactory::class,
            SinhalaStemFilterFactory.NAME,
            SinhalaStemFilterFactory::class
        ) { args -> SinhalaStemFilterFactory(args) }
        AnalysisSPIRegistry.register(
            TokenFilterFactory::class,
        ...
        AnalysisSPIRegistry.register(
            TokenFilterFactory::class,
            UzbekNormalizationFilterFactory.NAME,
            UzbekNormalizationFilterFactory::class
        ) { args -> UzbekNormalizationFilterFactory(args) }
        AnalysisSPIRegistry.register(
            TokenFilterFactory::class,
            UzbekStemFilterFactory.NAME,
            UzbekStemFilterFactory::class
        ) { args -> UzbekStemFilterFactory(args) }
        AnalysisSPIRegistry.register(
            TokenFilterFactory::class,
