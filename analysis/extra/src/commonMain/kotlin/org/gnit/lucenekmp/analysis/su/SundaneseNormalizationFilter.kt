...
/**
 * A [TokenFilter] that applies [SundaneseNormalizer] to normalize the orthography.
 *
 ...
 */
class SundaneseNormalizationFilter(input: TokenStream) : TokenFilter(input) {
    private val normalizer = SundaneseNormalizer()
