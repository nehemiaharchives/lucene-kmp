...
/** Analyzer for Hausa. */
class HausaAnalyzer : StopwordAnalyzerBase {
    ...
    override fun createComponents(fieldName: String): TokenStreamComponents {
        ...
        result = HausaNormalizationFilter(result)
        result = StopFilter(result, stopwords)
        result = HausaStemFilter(result)
    ...
    companion object {
        /** File containing default Hausa stopwords. */
...
# Source: local clone of stopwords-iso/stopwords-ha at ../stopwords-ha/stopwords-ha.txt
a
amma
ba
ban
