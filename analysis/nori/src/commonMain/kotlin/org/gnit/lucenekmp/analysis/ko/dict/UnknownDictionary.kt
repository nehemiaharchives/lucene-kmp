    ...
    companion object {
        ...
        private fun getClassResource(suffix: String): InputStream {
            val data = when (suffix) {
                TARGETMAP_FILENAME_SUFFIX -> KoreanDictionaryData.unknownTargetMap
                POSDICT_FILENAME_SUFFIX -> KoreanDictionaryData.unknownPosDict
                DICT_FILENAME_SUFFIX -> KoreanDictionaryData.unknownDict
