...
class TokenInfoDictionary internal constructor(
    ...
    companion object {
        ...
        internal fun getClassResource(suffix: String): InputStream {
            val data = when (suffix) {
                TARGETMAP_FILENAME_SUFFIX -> JapaneseDictionaryData.tokenInfoTargetMap
                POSDICT_FILENAME_SUFFIX -> JapaneseDictionaryData.tokenInfoPosDict
                DICT_FILENAME_SUFFIX -> JapaneseDictionaryData.tokenInfoDict
                FST_FILENAME_SUFFIX -> JapaneseDictionaryData.tokenInfoFst
    ...
    init {
        ...
        fstInput.use { input ->
            ...
            this.fst = TokenInfoFST(fst, true)
        }
    }
