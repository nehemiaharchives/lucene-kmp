...
class TestRussianLightStemFilterFactory : BaseTokenStreamFactoryTestCase() {
    companion object {
        init {
    ...
    fun testStemming() {
        val reader: Reader = StringReader("журналы")
        ...
        assertTokenStreamContents(stream, arrayOf("журнал"))
    }
