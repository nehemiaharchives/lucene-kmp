...
class TestItalianLightStemFilterFactory : BaseTokenStreamFactoryTestCase() {
    companion object {
        init {
    ...
    fun testStemming() {
        val reader: Reader = StringReader("ragazzo ragazzi")
        ...
        assertTokenStreamContents(stream, arrayOf("ragazz", "ragazz"))
    }
