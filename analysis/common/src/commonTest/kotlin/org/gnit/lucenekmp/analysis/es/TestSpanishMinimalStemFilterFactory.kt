 ...
 */
@Deprecated("Remove with SpanishMinimalStemFilterFactory")
class TestSpanishMinimalStemFilterFactory : BaseTokenStreamFactoryTestCase() {
    companion object {
        init {
    ...
    fun testStemming() {
        val reader: Reader = StringReader("camisetas")
        ...
        assertTokenStreamContents(stream, arrayOf("camiseta"))
    }
