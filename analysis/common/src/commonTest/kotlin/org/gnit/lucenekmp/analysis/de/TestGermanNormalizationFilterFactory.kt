...
class TestGermanNormalizationFilterFactory : BaseTokenStreamFactoryTestCase() {
    companion object {
        init {
    ...
    fun testStemming() {
        val reader: Reader = StringReader("weißbier")
        ...
        assertTokenStreamContents(stream, arrayOf("weissbier"))
    }
