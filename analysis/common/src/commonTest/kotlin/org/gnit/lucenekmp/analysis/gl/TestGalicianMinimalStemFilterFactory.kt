...
class TestGalicianMinimalStemFilterFactory : BaseTokenStreamFactoryTestCase() {
    companion object {
        init {
    ...
    fun testStemming() {
        val reader: Reader = StringReader("elefantes")
        ...
        assertTokenStreamContents(stream, arrayOf("elefante"))
    }
