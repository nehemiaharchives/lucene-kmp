    ...
    fun testParamsFactory() {
        ...
        var iae: IllegalArgumentException =
            expectThrows(IllegalArgumentException::class) {
                KeywordTokenizerFactory(makeArgs("maxTokenLen", "-1"))
            }
        assertEquals(
            "maxTokenLen must be greater than 0 and less than 1048576 passed: -1",
            iae.message
        )
        ...
        iae =
            expectThrows(IllegalArgumentException::class) {
                KeywordTokenizerFactory(makeArgs("maxTokenLen", "0"))
            }
        assertEquals(
        ...
        iae =
            expectThrows(IllegalArgumentException::class) {
                KeywordTokenizerFactory(makeArgs("maxTokenLen", "255", "randomParam", "rValue"))
            }
