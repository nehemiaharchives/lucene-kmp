...
class TestLatvianStemFilterFactory : BaseTokenStreamFactoryTestCase() {
    companion object {
        init {
    ...
    fun testStemming() {
        val reader: Reader = StringReader("tirgiem tirgus")
        ...
        assertTokenStreamContents(stream, arrayOf("tirg", "tirg"))
    }
