...
/** Simple tests for [PortugueseStemFilter]. */
class TestPortugueseStemFilter : BaseTokenStreamTestCase() {
    ...
    fun setUp() {
        analyzer = object : Analyzer() {
            override fun createComponents(fieldName: String): TokenStreamComponents {
                ...
                return TokenStreamComponents(source, PortugueseStemFilter(source))
            }
        }
    }
    ...
    fun testKeyword() {
        ...
        val a = object : Analyzer() {
            override fun createComponents(fieldName: String): TokenStreamComponents {
                ...
                return TokenStreamComponents(source, PortugueseStemFilter(sink))
            }
        }
    ...
    fun testEmptyTerm() {
        val a = object : Analyzer() {
            override fun createComponents(fieldName: String): TokenStreamComponents {
                ...
                return TokenStreamComponents(tokenizer, PortugueseStemFilter(tokenizer))
            }
        }
        checkOneTerm(a, "", "")
        a.close()
