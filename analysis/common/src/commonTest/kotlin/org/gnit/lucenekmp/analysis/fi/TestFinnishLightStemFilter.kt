...
/** Simple tests for [FinnishLightStemFilter] */
class TestFinnishLightStemFilter : BaseTokenStreamTestCase() {
        ...
        analyzer =
            object : Analyzer() {
                override fun createComponents(fieldName: String): TokenStreamComponents {
                    ...
                    return TokenStreamComponents(source, FinnishLightStemFilter(source))
                }
            }
    }
        ...
        val a =
            object : Analyzer() {
                override fun createComponents(fieldName: String): TokenStreamComponents {
                    ...
                    return TokenStreamComponents(source, FinnishLightStemFilter(sink))
                }
            }
        ...
        val a =
            object : Analyzer() {
                override fun createComponents(fieldName: String): TokenStreamComponents {
                    ...
                    return TokenStreamComponents(tokenizer, FinnishLightStemFilter(tokenizer))
                }
            }
        checkOneTerm(a, "", "")
        a.close()
