...
/** Simple tests for [GermanLightStemFilter]. */
class TestGermanLightStemFilter : BaseTokenStreamTestCase() {
    ...
    fun setUp() {
        analyzer = object : Analyzer() {
            override fun createComponents(fieldName: String): TokenStreamComponents {
                ...
                return TokenStreamComponents(source, GermanLightStemFilter(source))
            }
        }
    }
    ...
    fun testKeyword() {
        ...
        val a = object : Analyzer() {
            override fun createComponents(fieldName: String): TokenStreamComponents {
                ...
                return TokenStreamComponents(source, GermanLightStemFilter(sink))
            }
        }
    ...
    fun testEmptyTerm() {
        val a = object : Analyzer() {
            override fun createComponents(fieldName: String): TokenStreamComponents {
                ...
                return TokenStreamComponents(tokenizer, GermanLightStemFilter(tokenizer))
            }
        }
        checkOneTerm(a, "", "")
        a.close()
