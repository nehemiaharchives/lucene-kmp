...
/** Simple tests for [NorwegianLightStemFilter]. */
class TestNorwegianLightStemFilter : BaseTokenStreamTestCase() {
    ...
    fun setUp() {
        analyzer = object : Analyzer() {
            override fun createComponents(fieldName: String): TokenStreamComponents {
                ...
                return TokenStreamComponents(source, NorwegianLightStemFilter(source, BOKMAAL))
            }
        }
    }
    ...
    fun testKeyword() {
        ...
        val a = object : Analyzer() {
            override fun createComponents(fieldName: String): TokenStreamComponents {
                ...
                return TokenStreamComponents(source, NorwegianLightStemFilter(sink))
            }
        }
    ...
    fun testEmptyTerm() {
        val a = object : Analyzer() {
            override fun createComponents(fieldName: String): TokenStreamComponents {
                ...
                return TokenStreamComponents(tokenizer, NorwegianLightStemFilter(tokenizer))
            }
        }
        checkOneTerm(a, "", "")
        a.close()
