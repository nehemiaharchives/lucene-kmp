...
/**
 * Basic tests for [LithuanianStemmer]. We test some n/adj templates from wikipedia and some
 * high frequency terms from mixed corpora.
 */
class TestLithuanianStemming : BaseTokenStreamTestCase() {
