...
class TestSerbianNormalizationRegularFilter : BaseTokenStreamTestCase() {
    ...
    fun setUp() {
        analyzer = object : Analyzer() {
            override fun createComponents(fieldName: String): TokenStreamComponents {
                ...
                val stream: TokenStream = SerbianNormalizationRegularFilter(tokenizer)
    ...
    fun testEmptyTerm() {
        val a = object : Analyzer() {
            override fun createComponents(fieldName: String): TokenStreamComponents {
                ...
                return TokenStreamComponents(tokenizer, SerbianNormalizationRegularFilter(tokenizer))
            }
        }
        checkOneTerm(a, "", "")
        a.close()
