...
class TestFinnishLightStemFilterFactory : BaseTokenStreamFactoryTestCase() {
    companion object {
        init {
    ...
    fun testStemming() {
        val reader: Reader = StringReader("aseistettujen")
        ...
        assertTokenStreamContents(stream, arrayOf("aseistet"))
    }
