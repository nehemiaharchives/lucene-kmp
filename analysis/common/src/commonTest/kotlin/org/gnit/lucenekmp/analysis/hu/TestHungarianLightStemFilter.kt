...
/** Simple tests for [HungarianLightStemFilter] */
class TestHungarianLightStemFilter : BaseTokenStreamTestCase() {
    ...
    fun setUp() {
        analyzer = object : Analyzer() {
            override fun createComponents(fieldName: String): TokenStreamComponents {
                ...
                return TokenStreamComponents(source, HungarianLightStemFilter(source))
            }
        }
    }
    ...
    fun testKeyword() {
        ...
        val a = object : Analyzer() {
            override fun createComponents(fieldName: String): TokenStreamComponents {
                ...
                return TokenStreamComponents(source, HungarianLightStemFilter(sink))
            }
        }
    ...
    fun testEmptyTerm() {
        val a = object : Analyzer() {
            override fun createComponents(fieldName: String): TokenStreamComponents {
                ...
                return TokenStreamComponents(tokenizer, HungarianLightStemFilter(tokenizer))
            }
        }
        checkOneTerm(a, "", "")
        a.close()
