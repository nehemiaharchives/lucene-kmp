 ...
 * @lucene.spi [NAME]
 */
class GreekLowerCaseFilterFactory(args: MutableMap<String, String>) : TokenFilterFactory(args) {
    ...
    override fun create(input: TokenStream): TokenStream {
        return GreekLowerCaseFilter(input)
    }
    ...
    companion object {
        /** SPI name */
        const val NAME: String = "greekLowercase"
    }
}
