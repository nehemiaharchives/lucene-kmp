 ...
 * <br></br>
 * The defined map is:<br></br>
 * - every BooleanQueryNode instance is delegated to the SpanOrQueryNodeBuilder<br></br>
 * - every FieldQueryNode instance is delegated to the SpanTermQueryNodeBuilder <br></br>
 */
class SpansQueryTreeBuilder : QueryTreeBuilder(), StandardQueryBuilder {

    init {
        setBuilder(BooleanQueryNode::class, SpanOrQueryNodeBuilder())
        setBuilder(FieldQueryNode::class, SpanTermQueryNodeBuilder())
    }

    override fun build(queryTree: QueryNode): SpanQuery {
        return super.build(queryTree) as SpanQuery
    }
}
