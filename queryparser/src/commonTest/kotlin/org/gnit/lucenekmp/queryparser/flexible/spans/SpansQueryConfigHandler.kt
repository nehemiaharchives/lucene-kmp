...
/**
 * This query config handler only adds the [UniqueFieldAttribute] to it.<br></br>
 * <br></br>
 * It does not return any configuration for a field in specific.
 */
class SpansQueryConfigHandler : QueryConfigHandler() {

    // empty constructor

    override fun getFieldConfig(fieldName: String): FieldConfig? {
    ...
    companion object {
        val UNIQUE_FIELD: ConfigurationKey<String> = ConfigurationKey.newInstance()
    }
}
