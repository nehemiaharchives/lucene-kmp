...
class NonOverlapping(
    ...
    override fun toIntervalSource(field: String, analyzer: Analyzer): IntervalsSource {
        return Intervals.nonOverlapping(minuend.toIntervalSource(field, analyzer), subtrahend.toIntervalSource(field, analyzer))
    }

    override fun toString(): String {
        return "fn:nonOverlapping(" + minuend + " " + subtrahend + ")"
    }
}
