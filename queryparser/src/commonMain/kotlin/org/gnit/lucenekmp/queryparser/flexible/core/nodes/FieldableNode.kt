...
/**
 * A query node implements [FieldableNode] interface to indicate that its children and itself are
 * associated to a specific field.
 *
 * If it has any children which also implements this interface, it must ensure the children are
 * associated to the same field.
 */
interface FieldableNode : QueryNode {
    /**
     * Returns the field associated to the node and every node under it.
     *
     * @return the field name
     *
     * Associates the node to a field when assigned.
     *
