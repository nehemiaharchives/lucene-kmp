...
class NotContainedBy(
    private val small: IntervalFunction,
    private val big: IntervalFunction
) : IntervalFunction() {

    override fun toIntervalSource(field: String, analyzer: Analyzer): IntervalsSource {
        return Intervals.notContainedBy(small.toIntervalSource(field, analyzer), big.toIntervalSource(field, analyzer))
    }

    override fun toString(): String {
        return "fn:notContainedBy(" + small + " " + big + ")"
    }
}
