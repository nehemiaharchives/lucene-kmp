...
open class Token {
     ...
     * wants to return a non-null value can override this property as appropriate.
     */
    open val value: Any?
        get() = null
     ...
     */
    constructor(kind: Int) : this(kind, null)
    ...
    companion object {
         ...
         */
        fun newToken(ofKind: Int, image: String?): Token {
            return when (ofKind) {
                else -> Token(ofKind, image)
            }
        }

        fun newToken(ofKind: Int): Token {
