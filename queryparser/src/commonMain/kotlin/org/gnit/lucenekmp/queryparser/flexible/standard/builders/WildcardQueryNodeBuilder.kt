...
class WildcardQueryNodeBuilder : StandardQueryBuilder {
    init {
        // empty constructor
    }

    override fun build(queryNode: QueryNode): WildcardQuery {
        val wildcardNode = queryNode as WildcardQueryNode
        ...
        return WildcardQuery(
            Term(
                requireNotNull(wildcardNode.getFieldAsString()),
                requireNotNull(wildcardNode.getTextAsString()),
            ),
