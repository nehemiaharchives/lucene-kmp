...
class NotContaining(
    ...
    override fun toIntervalSource(field: String, analyzer: Analyzer): IntervalsSource {
        return Intervals.notContaining(minuend.toIntervalSource(field, analyzer), subtrahend.toIntervalSource(field, analyzer))
    }

    override fun toString(): String {
        return "fn:notContaining(" + minuend + " " + subtrahend + ")"
    }
}
