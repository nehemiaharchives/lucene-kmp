...
class UnorderedNoOverlaps(
    private val a: IntervalFunction,
    private val b: IntervalFunction
) : IntervalFunction() {

    override fun toIntervalSource(field: String, analyzer: Analyzer): IntervalsSource {
        return Intervals.unorderedNoOverlaps(a.toIntervalSource(field, analyzer), b.toIntervalSource(field, analyzer))
    }

    override fun toString(): String {
        return "fn:unorderedNoOverlaps(" + a + " " + b + ")"
    }
}
